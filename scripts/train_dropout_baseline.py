"""Runs the OULAD dropout-risk baseline comparison experiment end-to-end.

Fetches the day-30 snapshot from Postgres, trains the logistic-regression
baseline and a random-forest comparison model on the identical feature
matrix and splits, and prints train/val/test metrics for both. Diagnostic/
experiment script, not a persisted pipeline — see
docs/datasets/dropout-prediction-feature-design.md for the design this
implements.

Run as: python -m scripts.train_dropout_baseline
"""
